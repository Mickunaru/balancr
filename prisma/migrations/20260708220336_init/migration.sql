-- CreateEnum
CREATE TYPE "ItemStatus" AS ENUM ('ACTIVE', 'LOGIN_REQUIRED', 'ERROR');
...
-- AddForeignKey
ALTER TABLE "BankAccount" ADD CONSTRAINT "BankAccount_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES "Item"("id") ON DELETE CASCADE ON UPDATE CASCADE;
